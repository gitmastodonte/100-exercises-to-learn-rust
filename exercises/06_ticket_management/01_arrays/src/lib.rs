...
pub struct WeekTemperatures {
    weekdaysTemperatures: [Option<i32>; 7]
}
...
impl WeekTemperatures {
    pub fn new() -> Self {
        WeekTemperatures { weekdaysTemperatures: [None; 7] }
    }

    fn get_index_of_weekday(day: &Weekday) -> usize{
        match day {
            Weekday::Monday => 0,
            Weekday::Tuesday => 1,
            Weekday::Wednesday => 2,
    ...
    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        let index = WeekTemperatures::get_index_of_weekday(&day);

        self.weekdaysTemperatures[index]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        let index = WeekTemperatures::get_index_of_weekday(&day);

        self.weekdaysTemperatures[index] = Some(temperature)
    }
}
